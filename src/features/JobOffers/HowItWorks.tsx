...
const HowItWorks: React.FC = () => {
  ...
  return (
    <Container>
          ...
          >
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">Apply Online</h3>
                  <p className="text-secondary-black font-light">
                    Tell us your skills and goals.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">Get Matched</h3>
                  <p className="text-secondary-black font-light">
                    We’ll connect you to job openings that fit.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-black font-light">
                    We help you prep, apply, and succeed.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-black font-light">
                    From embassy to airport, we guide you all the way.
                  </p>
                </div>
              </motion.div>
            </motion.div>
      ...
      {/* CTA Section */}
      <motion.div
        className="bg-primary-orange rounded-3xl p-12 text-center text-white sm:mt-16"
