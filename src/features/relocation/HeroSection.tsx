...
const HeroSection = () => {
  ...
  return (
    <Container>
      ...
      >
        ...
        <div className="flex-1 lg:pr-8">
          ...
          <motion.h1
            ...
            variants={itemVariants}
          >
            Start Your New Life in Europe We’ll Guide You Every Step of the Way
          </motion.h1>
        ...
        <motion.div
          ...
          variants={itemVariants}
        >
          <p className="font-light text-lg sm:text-xl text-secondary-black text-center lg:text-left max-w-[475px] mt-4 lg:mt-[80px] px-4 lg:px-0">
            Moving to Europe can be exciting but also overwhelming. At ARJUN
            GLOBAL SERVICES, we make it easy. Whether you're relocating for
            work, study, or a fresh start, our team helps you handle everything
            from visas and housing to job placements and travel logistics.
          </p>
        </motion.div>
      </motion.div>
      ...
      >
        <Image
          src="/images/relocation/hero.png"
          alt="hero"
          fill
