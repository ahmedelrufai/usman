      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <motion.div className="order-2 lg:order-1" variants={imageVariants}>
            ...
            >
              <div className="aspect-[6/5]">
                <Image
                  src="/images/relocation/support.png"
          ...
          >
            ...
            >
              What’s Included in Our Relocation Support
            </motion.h1>
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-black font-light">
                    We help you apply for the right visa with complete, correct
                    paperwork.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-black font-light">
                    Get connected with real, verified job opportunities across
                    Europe.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-black font-light">
                    We’ll help you find a comfortable place to live even before
                    you arrive.
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-secondary-black font-light">
                    Book flights, arrange airport pickup, and plan a smooth
                    journey.
                  </p>
                </div>
              </motion.div>
