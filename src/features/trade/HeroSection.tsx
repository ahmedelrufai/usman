      ...
      >
          ...
          >
            ...
            >
              <Button
                ...
                onClick={() => router.push("/")}
                hideOnMobile={false}
                className="sm:w-auto max-sm:mx-auto sm:mt-10"
              />
            </motion.div>
          </motion.div>
        </div>
        ...
        >
          <p className="font-light text-lg sm:text-xl text-secondary-black text-center lg:text-left max-w-[475px] mt-4 lg:mt-[80px] px-4 lg:px-0">
            Explore professional support across travel, visas, job placement,
            trade, real estate, logistics, and more all under one roof.
          </p>
        </motion.div>
      </motion.div>
