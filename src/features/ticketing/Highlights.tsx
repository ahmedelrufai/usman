          ...
          <motion.div className="order-2 lg:order-1" variants={imageVariants}>
            ...
            >
              <div className="aspect-[5/4]">
                <Image
                  src="/images/ticketing/highlight.png"
                  alt="T"
                  fill
          ...
          >
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">
                    Flight bookings (local & international)
                  </h3>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">
                    Last-minute or advance bookings
                  </h3>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">
                    Personalized support no bots, just people
                  </h3>
                </div>
              </motion.div>
