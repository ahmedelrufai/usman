...
const WhyUs: React.FC = () => {
  ...
  return (
    <Container>
          ...
          <motion.div className="order-2 lg:order-1" variants={imageVariants}>
            ...
            >
              <div className="aspect-[5/4]">
                <Image
                  src="/images/car-rentals/why-us.png"
                  alt="T"
                  fill
          ...
          >
            ...
            <motion.div className="space-y-6" variants={itemVariants}>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">
                    Easy booking and pick-up options
                  </h3>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">
                    Courteous, trained drivers (if needed)
                  </h3>
                </div>
              </motion.div>
              ...
              >
                ...
                <div>
                  <h3 className="text-lg font-medium mb-1">
                    Full-service support and insurance coverage
                  </h3>
                </div>
              </motion.div>
            </motion.div>
      ...
      {/* CTA Section */}
      <motion.div className="bg-blue rounded-3xl p-12 text-center text-white md:mt-16 mb-16">
        <h2 className="text-3xl md:text-[40px] font-medium mb-4">
          Need a car today?
        </h2>

        <p className="text-lg mb-12 max-w-2xl mx-auto">
          Book your ride now and experience smooth, affordable travel with ARJUN
          GLOBAL SERVICES.
        </p>
